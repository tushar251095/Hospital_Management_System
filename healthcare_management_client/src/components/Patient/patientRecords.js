                ...
                <table className="table table-bordered table-striped">
                  <tbody>
                    ...
                    <tr>
                      <th>Height</th>
                      <td>
                        {details.appointmentDetails.height }
                      </td>
                    </tr>
                    <tr>
                      <th>Weight</th>
                      <td>
                        {details.appointmentDetails.weight }
                      </td>
                    </tr>
                    <tr>
                      <th>Blood Group</th>
                      <td>
                        {details.appointmentDetails.bloodGroup }
                      </td>
                    </tr>
                    <tr>
                      <th>Blood Pressure</th>
                      <td>
                        {details.appointmentDetails.bloodPressure }
                      </td>
                    </tr>
                    <tr>
                      <th>Sugar Level</th>
                      <td>
                        {details.appointmentDetails.sugarLevel }
                      </td>
                    </tr>
                    <tr>
                      <th>Doctor Comment</th>
                      <td>
                        {details.appointmentDetails.comment }
                      </td>
                    </tr>
                    <tr>
                      <th>Doctor Prescription</th>
                      <td>
                        {details.appointmentDetails.prescription }
                      </td>
                    </tr>
                  </tbody>
                </table>
